...
<html>
    ...
    <div class="row">
                ...
                <form action="<?php echo site_url('galeri/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                          <button type="button" class="btn btn-success" onclick="lookup('<?php echo base_url()?>galeri/lookup')" >Search</button>
                        </span>
                    </div>
                </form>
            </div>
		...
		<th class="text-center">Isactive</th></tr>
			...
			<td><?php echo $galeri->note ?></td>
			<td><?php echo $galeri->add_1 ?></td>
			<td><?php echo $galeri->add_2 ?></td>
			<td><?php echo $galeri->created_at ?></td>
			<td><?php echo $galeri->created_by ?></td>
			<td><?php echo $galeri->updated_at ?></td>
			<td><?php echo $galeri->updated_by ?></td>
			<td><?php echo $galeri->isactive ?></td>
		</tr>
