...
<html>
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h2 style="margin-top:0px">Prestasi_siswa Read</h2>
        ...
        <table class="table">
	    <tr><td>Jenis Prestasi</td><td><?php echo $jenis_prestasi; ?></td></tr>
	    <tr><td>Nama Siswa</td><td><?php echo $nama_siswa; ?></td></tr>
	    <tr><td>Nama Prestasi</td><td><?php echo $nama_prestasi; ?></td></tr>
	    <tr><td>Juara</td><td><?php echo $juara; ?></td></tr>
	    <tr><td>Tahun Perolehan</td><td><?php echo $tahun_perolehan; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('prestasi_siswa') ?>" class="btn btn-default">Cancel</a></td></tr>
	</table>
            </div>
        </div>
    </div>
