...
<html>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h2 style="margin-top:0px"><?php echo $button ?> Prestasi_siswa </h2>
                </div>
	    ...
	    <div class="form-group">
            ...
            <input type="hidden" name="nama_siswa" id="nama_siswa" value="<?php echo $nama_siswa; ?>" />
            <input type="text" class="form-control" name="nm_nama_siswa" id="nm_nama_siswa" placeholder="Nama Siswa" value="<?php echo $nm_nama_siswa ?>" readonly/>
            <div class="input-group-addon" onclick="lookup('<?=base_url()?>siswa/lookup','nama_siswa');" style="cursor: pointer;">
                <span>Cari</span>
            </div>
        </div>
        </div>
	    ...
	    <a href="<?php echo site_url('prestasi_siswa') ?>" class="btn btn-default">Cancel</a>
	</div>
    </div>
    </div>
            </form>
