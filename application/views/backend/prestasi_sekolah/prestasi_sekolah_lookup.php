...
<html>
    ...
    <div class="row">
                ...
                <form action="<?php echo site_url('prestasi_sekolah/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                          <button type="button" class="btn btn-success" onclick="lookup('<?php echo base_url()?>prestasi_sekolah/lookup')" >Search</button>
                        </span>
                    </div>
                </form>
            </div>
		...
		<th class="text-center">Note</th></tr>
			...
			<td><?php echo $prestasi_sekolah->updated_at ?></td>
			<td><?php echo $prestasi_sekolah->updated_by ?></td>
			<td><?php echo $prestasi_sekolah->isactive ?></td>
			<td><?php echo $prestasi_sekolah->add_1 ?></td>
			<td><?php echo $prestasi_sekolah->add_2 ?></td>
			<td><?php echo $prestasi_sekolah->note ?></td>
		</tr>
