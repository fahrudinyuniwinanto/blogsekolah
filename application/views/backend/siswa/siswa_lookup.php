...
<html>
    ...
    <div class="row">
                ...
                <form action="<?php echo site_url('siswa/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                          <button type="button" class="btn btn-success" onclick="lookup('<?php echo base_url() ?>siswa/lookup')" >Search</button>
                        </span>
                    </div>
                </form>
            </div>
		...
		<th class="text-center">Alumni</th></tr>
            </thead>
			<tbody><?php
foreach ($siswa_data as $siswa) {
	?>
            <tr onclick="setVal('<?=$idhtml?>','<?=$siswa->id_siswa?>','<?=$siswa->fullname?>')" style="cursor: pointer">
