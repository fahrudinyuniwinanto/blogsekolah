...
<html>
    ...
    <div class="row">
                ...
                <form action="<?php echo site_url('prestasi_guru/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                          <button type="button" class="btn btn-success" onclick="lookup('<?php echo base_url()?>prestasi_guru/lookup')" >Search</button>
                        </span>
                    </div>
                </form>
            </div>
		...
		<th class="text-center">Note</th></tr>
			...
			<td><?php echo $prestasi_guru->updated_at ?></td>
			<td><?php echo $prestasi_guru->updated_by ?></td>
			<td><?php echo $prestasi_guru->isactive ?></td>
			<td><?php echo $prestasi_guru->add_1 ?></td>
			<td><?php echo $prestasi_guru->add_2 ?></td>
			<td><?php echo $prestasi_guru->note ?></td>
		</tr>
